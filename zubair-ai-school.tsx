          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
            ...
            <div className="bg-white bg-opacity-10 rounded-xl p-8 text-white backdrop-blur-sm">
              ...
              <Button 
                ...
                className="bg-white bg-opacity-90 hover:bg-white text-purple-600 hover:text-purple-700 font-bold px-8 py-4 text-lg rounded-full border-2 border-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 w-full"
              >
                Fill Form
              </Button>
            </div>
